...
XWarpPointer.argtypes = (DisplayPtr, Window, Window, cts.c_int, cts.c_int, cts.c_uint, cts.c_uint, cts.c_int, cts.c_int)
...
XQueryPointer.argtypes = (DisplayPtr, Window, WindowPtr, WindowPtr, IntPtr, IntPtr, IntPtr, IntPtr, UIntPtr)
...
def _open_display(name=None, quit_on_error=False, verbose=False):
    ...
    global __warn
    if __warn:
        print("----- X Server custom config. There's a chance it might be unresponsive -----")
        __warn = False
